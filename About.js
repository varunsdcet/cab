...
export default class About extends Component {
    ...
    componentDidMount(){
        ...
        if (a == 1){
            this.setState({location :'About Us'})
        } else if (a == 2){
            this.setState({location :'Support'})
        }else if (a == 3){
            this.setState({location :'Terms and Condition'})
        }else if (a == 4){
            this.setState({location :'Privacy Policy'})
        }


        const url = 'http://139.59.76.223/cab/webservices/setting'
        ...
        fetch(url, {
            ...
            .then((responseJson) => {
                ...
                if (responseJson.status == true){
                    ...
                    if (a == 1){
                        this.setState({package:responseJson.data.about_us})
                    } else if (a == 2){
                        this.setState({package:responseJson.data.support})
                    }else if (a == 3){
                        this.setState({package:responseJson.data.terms_conditions})
                    }else if (a == 4){
                        this.setState({package:responseJson.data.privacy_policy})
                    }
        ...
        return (
            <View  style = {{backgroundColor:Colors.background,height:height,flexDirection:'column'}} >
                ...
                <View style={{width:window.width,height:60,backgroundColor:Colors.blue}}>
                    ...
                    <HTML html={this.state.package} imagesMaxWidth={Dimensions.get('window').width} />
