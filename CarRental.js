...
//toLocation
    ...
    componentDidMount(){
        ...
        const url = 'http://139.59.76.223/cab/webservices/car_rental_duration'
    ...
    handleClick1 = () => {
        ...
        GLOBAL.type = 'CarRental'
        alert(GLOBAL.did)


        this.setState({visible:false})

        const url = 'http://139.59.76.223/cab/webservices/get_cab_categories_rental'
...
GLOBAL.did = this.state.data[index].id
...
<View>
                    ...
                    <Text style={{ color: 'black', fontFamily:GLOBAL.heavy, fontSize: 16,marginTop:10,marginLeft:20 }}>For {itemData.item.time} </Text>
    <Text style={{ color: '#8a8a8f', fontFamily:GLOBAL.roman, fontSize: 12,marginTop:2,marginLeft:20 }}>Upto {itemData.item.km} </Text>
</View>



                </View>
                <View style={{backgroundColor:'#8a8a8f',height:1,width:'100%'}}>
                    ...
                    >
                        <DialogContent>
                            ...
                            <View style={{width:window.width-100}}>
                                ...
                                <FlatList style = {{width:window.width,height:300}}
