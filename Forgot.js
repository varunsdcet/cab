        ...
        return (
            <View style={{backgroundColor:'#FBD303',height:window.height}}  >
                ...
                <KeyboardAwareScrollView>
                    ...
                    <Text style={{ color: 'black', fontFamily:GLOBAL.heavy,fontWeight:'bold', fontSize: 32,marginTop:30,marginLeft:20,width:200 }}>Forgot your Password</Text>
                    <Text style={{ color: '#333a4d', fontFamily:GLOBAL.roman, fontSize: 14,marginLeft:20,width:200,marginTop:20 }}>Enter your email/mobile no below to receive your password reset instruction </Text>
